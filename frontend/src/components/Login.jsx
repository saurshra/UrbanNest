...
const Login = () => {
  const { user, setUser } = useContext(AirbnbContext);
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="bg-white shadow-md rounded-lg p-8 w-96 border border-gray-200">
        ...
        <form onSubmit={handleSubmitUser}>
          ...
          <button
            type="submit"
            className="w-full bg-red-500 text-white py-3 rounded-lg font-semibold hover:bg-red-600 transition duration-300 cursor-pointer"
          >
            Log in
          </button>
        </form>
